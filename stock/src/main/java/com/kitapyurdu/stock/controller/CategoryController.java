...
public class CategoryController {
    ...
    public CategoryResponse findCategory(@PathVariable(value = "categoryId") String categoryId) {
        CategoryResponse categoryResponse = new CategoryResponse();
        Meta meta = new Meta();
        CategoryDto categoryDto = categoryService.findCategoryByDto(Integer.parseInt(categoryId));
        meta.errorCode = 200;
        meta.errorDesc = "Bulunan kategori :" + categoryId;
